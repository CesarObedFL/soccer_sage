                                                        ...
                                                        <tr wire:key="league-{{ $match_index }}" class="w-96 hover:bg-gray-100 transition-colors group">
                                                            ...
                                                            <td class="py-4 px-4 text-center"> 
                                                                @if ($match['status']->long == 'Match Finished') 
                                                                    <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400 uppercase">{{ $match['status']->long }}</span> 
                                                                @elseif ($match['status']->long == 'Not Started') 
                                                                    <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400 uppercase">{{ $match['status']->long }}</span> 
                                                                @else
                                                                    <span class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300">{{ $match['status']->long }}</span>
                                                                @endif
                                                            ...
                                                            <td class="py-4 px-4 text-center">
                                                                @if ($match['is_home_team_saved'])
                                                                    <span class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400 uppercase">true</span> 
                                                                @else 
                                                                    <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400 uppercase">false</span> 
                                                                @endif
                                                            </td>
                                                            <td class="py-4 px-4 text-center">
                                                                @if ($match['is_away_team_saved']) 
                                                                    <span class="bg-green-300 text-green-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400 uppercase">true</span> 
                                                                @else 
                                                                    <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2 py-1.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400 uppercase">false</span> 
                                                                @endif
                                                            </td>
